...
impl NFCRegType {
    ...
    pub fn lookup_offset(offset: usize) -> Option<Self> {
        ...
        match offset {
            0x000 => { Some(NFCRegType::TAGHEADER0) }
            0x004 => { Some(NFCRegType::TAGHEADER1) }
            0x008 => { Some(NFCRegType::TAGHEADER2) }
            0x00C => { Some(NFCRegType::TAGHEADER3) }
            _ => { None }
        }
    }
}
...
impl NFCRegType {
    pub(super) fn _data(&self) -> &'static RegInfo {
        match self {
            NFCRegType::TAGHEADER0      => { &RegInfo { offset: 0x000, perms: 0b100, reset: Some(0xFFFFFF5F) } }
            NFCRegType::TAGHEADER1      => { &RegInfo { offset: 0x004, perms: 0b100, reset: Some(0xFFFFFFFF) } }
            NFCRegType::TAGHEADER2      => { &RegInfo { offset: 0x008, perms: 0b100, reset: Some(0xFFFFFFFF) } }
            NFCRegType::TAGHEADER3      => { &RegInfo { offset: 0x00c, perms: 0b100, reset: Some(0xFFFFFFFF) } }
