...
//   Backend's event queue (Backend.events)

pub struct UserOp {
    pub index: usize,
    pub name: &'static str,
    pub func: fn(&mut Backend, usize, &[VarnodeData], Option<&VarnodeData>) -> Result<Option<Location>, backend::Error>,
}
...
fn _count_leading_zeroes(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
/// output:
/// - none
fn _software_interrupt(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _software_bkpt(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _software_udf(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _software_hlt(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _software_hvc(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _software_smc(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _set_user_mode(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _set_fiq_mode(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _set_irq_mode(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _set_supervisor_mode(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _set_monitor_mode(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _set_abort_mode(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _set_undefined_mode(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _set_system_mode(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
/// - none
#[instrument]
fn _enable_irq_interrupts(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
/// - none
#[instrument]
fn _enable_fiq_interrupts(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _enable_dataabort_interrupts(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
/// - none
#[instrument]
fn _disable_irq_interrupts(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
/// - none
#[instrument]
fn _disable_fiq_interrupts(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _is_fiq_interrupts_enabled(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _is_irq_interrupts_enabled(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _disable_dataabort_interrupts(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
#[instrument]
fn _has_exclusive_access(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
#[instrument]
fn _is_current_mode_privileged(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
/// output:
/// - none
fn _set_thread_mode_privileged(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
    ...
    let val = this.read(&inputs[0])?.bit(0);
...
fn _is_thread_mode(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _jazelle_branch(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _clear_exclusive_local(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _hint_debug(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
#[instrument]
fn _data_memory_barrier(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
    ...
    let option_val = this.read(&inputs[0])?.to_u8().unwrap();
...
/// (see Memory barriers in A3.7.3)
#[instrument]
fn _data_synchronization_barrier(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _secure_monitor_func(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
/// output:
/// - none
fn _wait_for_event(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
/// output:
/// - none
fn _wait_for_interrupt(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _hint_yield(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _hint_preload_data_for_write(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _hint_preload_instruction(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _signed_saturate(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _signed_does_saturate(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _unsigned_saturate(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _unsigned_does_saturate(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _reverse_bit_order(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _send_event(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _set_endian_state(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _index_check(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
/// - none
#[instrument]
fn _exclusive_access(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
    ...
    let in0 = this.read(&inputs[0])?;
    let address = bv2addr(in0.clone())
        .ok_or_else(|| Error::InvalidAddress(in0))?;
...
fn _get_main_stack_pointer(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _get_process_stack_pointer(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _get_base_priority(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _get_current_exception_number(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _is_thread_mode_privileged(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
fn _is_using_main_stack(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
/// output:
/// - none
fn _set_main_stack_pointer(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
/// output:
/// - none
fn _set_process_stack_pointer(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
/// output:
/// - none
fn _set_base_priority(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
...
/// output:
/// - none
fn _set_stack_mode(this: &mut Backend,
    index: usize,
    inputs: &[VarnodeData],
    output: Option<&VarnodeData>,
) -> Result<Option<Location>, backend::Error> {
