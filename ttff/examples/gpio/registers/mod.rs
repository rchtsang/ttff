...
impl GPIORegType {
    ...
    pub fn lookup_offset(offset: usize) -> Option<Self> {
        ...
        match offset {
            ...
            0x700..=0x77f => { Some(GPIORegType::PIN_CNF(((offset - 1792) / 4) as u8)) }
            _ => { None }
        }
    }
...
impl GPIORegType {
    fn _data(&self) -> &'static RegInfo {
        match self {
            GPIORegType::OUT => { &RegInfo { offset: 1284, perms: 0b110, reset: None } }
            GPIORegType::OUTSET => { &RegInfo { offset: 1288, perms: 0b110, reset: None } }
            GPIORegType::OUTCLR => { &RegInfo { offset: 1292, perms: 0b110, reset: None } }
            GPIORegType::IN => { &RegInfo { offset: 1296, perms: 0b100, reset: None } }
            GPIORegType::DIR => { &RegInfo { offset: 1300, perms: 0b110, reset: None } }
            GPIORegType::DIRSET => { &RegInfo { offset: 1304, perms: 0b110, reset: None } }
            GPIORegType::DIRCLR => { &RegInfo { offset: 1308, perms: 0b110, reset: None } }
            GPIORegType::LATCH => { &RegInfo { offset: 1312, perms: 0b110, reset: None } }
            GPIORegType::DETECTMODE => { &RegInfo { offset: 1316, perms: 0b110, reset: None } }
            GPIORegType::PIN_CNF(0) => { &RegInfo { offset: 1792, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(1) => { &RegInfo { offset: 1796, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(2) => { &RegInfo { offset: 1800, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(3) => { &RegInfo { offset: 1804, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(4) => { &RegInfo { offset: 1808, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(5) => { &RegInfo { offset: 1812, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(6) => { &RegInfo { offset: 1816, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(7) => { &RegInfo { offset: 1820, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(8) => { &RegInfo { offset: 1824, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(9) => { &RegInfo { offset: 1828, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(10) => { &RegInfo { offset: 1832, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(11) => { &RegInfo { offset: 1836, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(12) => { &RegInfo { offset: 1840, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(13) => { &RegInfo { offset: 1844, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(14) => { &RegInfo { offset: 1848, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(15) => { &RegInfo { offset: 1852, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(16) => { &RegInfo { offset: 1856, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(17) => { &RegInfo { offset: 1860, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(18) => { &RegInfo { offset: 1864, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(19) => { &RegInfo { offset: 1868, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(20) => { &RegInfo { offset: 1872, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(21) => { &RegInfo { offset: 1876, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(22) => { &RegInfo { offset: 1880, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(23) => { &RegInfo { offset: 1884, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(24) => { &RegInfo { offset: 1888, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(25) => { &RegInfo { offset: 1892, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(26) => { &RegInfo { offset: 1896, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(27) => { &RegInfo { offset: 1900, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(28) => { &RegInfo { offset: 1904, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(29) => { &RegInfo { offset: 1908, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(30) => { &RegInfo { offset: 1912, perms: 0b110, reset: Some(0x00000002) } }
            GPIORegType::PIN_CNF(31) => { &RegInfo { offset: 1916, perms: 0b110, reset: Some(0x00000002) } }
